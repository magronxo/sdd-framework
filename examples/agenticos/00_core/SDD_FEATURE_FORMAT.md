...
```json
{
  ...
  "design_path": "00_project_documentation/SDD/artifacts/design/feat-001-path-validation.md",
  "spec_path": "00_project_documentation/SDD/artifacts/specs/feat-001-path-validation.md",
  "sdt_scenarios": [
    {
  ...
  "task_path": "00_project_documentation/SDD/artifacts/tasks/feat-001-path-validation.md",
  "task_list": [
...
```json
{
  "design_path": "00_project_documentation/SDD/artifacts/design/feat-XXX_nom.md",
  "spec_path": "00_project_documentation/SDD/artifacts/specs/feat-XXX_nom.md"
}
```
...
```json
{
  "design_path": "/SDD/artifacts/design/feat-XXX_nom.md",
  "spec_path": "/SDD/artifacts/specs/feat-XXX_nom.md"
}
```
...
- Els documents es guarden a `00_project_documentation/SDD/artifacts/features_for_specs/`.
