...
- **Paths are explicit:** use `00_project_documentation/SDD/artifacts/...` as canonical artifact roots.
...
- Related legacy/consolidated design notes only if needed: `01_design/`

**Must produce**
- Design doc: `00_project_documentation/SDD/artifacts/design/<feature_id>.md`
...
**Must produce**
- Spec doc: `00_project_documentation/SDD/artifacts/specs/<feature_id>.md`
...
**Must produce**
- Tasks doc: `00_project_documentation/SDD/artifacts/tasks/<feature_id>.md`
...
**Must produce**
- Audit report: `00_project_documentation/SDD/audit_reports/<report>.md`
