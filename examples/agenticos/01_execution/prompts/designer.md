...
**ABANS de crear cap disseny nous**, llegeix TOTS els documents existents a `01_design/` que puguin estar relacionats amb aquesta feature. 

Pas a seguir:
1. Llista els fitxers a `01_design/` i `00_project_documentation/SDD/artifacts/design/`
2. Llegeix els documents rellevants (Kernel, Ticket System, Guardian, etc.)
...
## Output
Has de crear: `00_project_documentation/SDD/artifacts/design/<feature_id>.md`
...
## 5. Hardware Budget
- RAM: X MB (peak)
- CPU: X% en operació normal
- Disc: X MB addicionals
...
3. **Hardware budget obligatori** per Orange Pi 5B
...
{
  "state": "SPEC",
  "design_path": "00_project_documentation/SDD/artifacts/design/<feature_id>.md",
