...
**Canonical spec**  
A spec located under `00_project_documentation/SDD/artifacts/specs/` that is intended to govern behavior.

**Legacy spec / legacy content**  
Any spec-like document that is:
- outside `00_project_documentation/SDD/artifacts/specs/`, or
...
1) Resolve the *canonical* spec path under `00_project_documentation/SDD/artifacts/specs/`.
2) If the spec is not validated, STOP and request VALIDATION.
3) If a spec/tasks doc claims “implemented”, but the code lacks it:
   - open an alignment report under `00_project_documentation/SDD/audit_reports/`
