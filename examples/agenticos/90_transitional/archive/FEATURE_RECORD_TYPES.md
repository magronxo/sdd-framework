...
ARCHIVE_REASON: Transitional model note; outcomes applied to feature records (composite/subfeature/legacy_record).
CANONICAL_SUCCESSOR: `00_project_documentation/SDD/00_core/SDD_FEATURE_FORMAT.md`
