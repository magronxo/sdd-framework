...
ARCHIVE_REASON: Transitional priority plan; contains outdated status/paths vs current `artifacts/` layout.
CANONICAL_SUCCESSOR: `00_project_documentation/SDD/03_operations/SPEC_REAUDIT_WORKFLOW.md` and `00_project_documentation/SDD/03_operations/ROADMAP.md`
POLICY_SUCCESSOR: `00_project_documentation/SDD/02_policies/SPECS_REAUDIT_PRIORITIZATION_POLICY.md`
