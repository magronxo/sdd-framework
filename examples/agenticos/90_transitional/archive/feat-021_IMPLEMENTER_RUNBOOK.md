...
ARCHIVE_REASON: Per-feature sample runbook; replaced by canonical role prompt + canonical tasks.
CANONICAL_SUCCESSOR: `00_project_documentation/SDD/01_execution/prompts/implementer.md` + `00_project_documentation/SDD/artifacts/tasks/feat-021-session-ticket-linkage.md`
