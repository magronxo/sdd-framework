...
Canonical PRE-SDD runtime: `00_project_documentation/SDD/03_operations/pre_sdd/PRE_SDD_RUNTIME.md`
Archived copy (with archive header): `00_project_documentation/SDD/90_transitional/archive/PROVISIONAL_IMPLEMENTATION_READINESS_WORKFLOW.md`
